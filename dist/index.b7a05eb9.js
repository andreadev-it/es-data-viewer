...
async function filesLoaded(lib, sprites, data) {
    let systemView = new (0, _system.SystemView)(data, sprites, lib);
    views.system = systemView;
    views.galaxy = new (0, _galaxy.GalaxyView)(data, sprites, lib);
    await setCurrentView(lib, "galaxy");
    await lib.paint();
}

},{"@andreadev/canvas-lib":"hyshD","@andreadev/canvas-lib/dist/modules/pan-zoom-plugin":"5BQTv","./views/galaxy":"yrYA6","./views/system":"9LiF6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hyshD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
